...
def websocket_message(flow: http.HTTPFlow):
    ...
    if message.from_client:
        ...
        for pair in pairs:
            ...
            txns=pair['txns']
            volume=pair['baseToken']
            print((json.dumps(baseToken),chainId,dexId,json.dumps(liquidity),marketCap,pairAddress,pairCreatedAt,priceUsd,json.dumps(quoteToken),json.dumps(txns),json.dumps(volume)) )
            # cursor.execute("""
